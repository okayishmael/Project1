...
let origin = prompt(name + " Enter your current City:"); // prompt, input require
let gender = prompt(name + " please enter your Gender:");// prompt, input require
let coder = confirm(name + ' Click "OK" if you are a coder.'); // declare var confirm to collect user input
